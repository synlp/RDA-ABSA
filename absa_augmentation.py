...
import json
model_id = "/media/ubuntu/data/junjie/LLaMA-Factory-main/LLaMA-Factory-main/output/llama3_dpo_rest15_8"
input_file = "dataset/rest15_train.json"
output_file1 = "data/rest15_augmentation.json"
...
for item in tqdm(original_data, desc="Processing"):
        ...
        new_item = {
            "instruction": "Predict the sentiment of the given aspect in the text.",
            "input": item["input"].replace(original_text, enhanced_text),
            "output": item["output"]
        }
        augmented_data1.append(new_item)
        augmented_data1.append(item)
